...
switch($mode){
     ...
     case 'login':
      ...
      $session->setSession("Last_name", $user_accounts[2]);
      $session->setSession("id", $user_accounts[0]);
      $session->setSession("role", $user_accounts[5]);
         ...
         ';
          ...
          <div class="col-sm-3 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="200" data-aos-delay="fade-up">
            <div class="p-3 shadow mb-4 border-0 ">
              ...
              <a class="btn btn-get-started w-100" href="?product='. $row["ppi_product_id"] .'">View Product</a>
            </div>
          </div>';
          }
          echo "
